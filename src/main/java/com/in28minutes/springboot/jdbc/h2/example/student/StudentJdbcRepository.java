...
public class StudentJdbcRepository {
	...
	class StudentRowMapper implements RowMapper<Student> { // from resultset to student object /// who wrote this code : developer // customization
		@Override
	...
	public Student findById(long id) {
		return jdbcTemplate.queryForObject("select * from student where id=?", new Object[] { id },
				new BeanPropertyRowMapper<Student>(Student.class)); // spring will do the mapping for you for you.
	}
